    ...
    <div id="page-container" class="fade">
        ...
        <div id="home" class="content has-bg home">
            ...
            <div class="content-bg">
                <img src="<?=base_url();?>img/bg/bg-home.jpg" alt="Home" />
            </div>
            <!-- end content-bg -->
            <!-- begin container -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        ...
                        <div class="about-author">
                            ...
                            <div class="author">
                                <div class="image">
                                    <img src="<?=base_url();?>img/user/user-1.jpg" alt="Sean Ngu" />
                                </div>
                                <div class="info">
                                    Sean Ngu
        ...
        <div id="milestone" class="content bg-black-darker has-bg" data-scrollview="true">
            <!-- begin content-bg -->
            <div class="content-bg">
                <img src="<?=base_url();?>img/bg/bg-milestone.jpg" alt="Milestone" />
            </div>
            <!-- end content-bg -->
            <!-- begin container -->
            <div class="container">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                        ...
                        <div class="team">             
                            <div class="image" data-animation="true" data-animation-type="flipInX">
                                <img src="<?=base_url();?>img/user/user-1.jpg" alt="Ryan Teller" />
                            </div>
                            <div class="info">
                    ...
                    <div class="col-md-4 col-sm-4">
                        ...
                        <div class="team">             
                            <div class="image" data-animation="true" data-animation-type="flipInX">
                                <img src="<?=base_url();?>img/user/user-2.jpg" alt="Jonny Cash" />
                            </div>
                            <div class="info">
                    ...
                    <div class="col-md-4 col-sm-4">
                        ...
                        <div class="team">             
                            <div class="image" data-animation="true" data-animation-type="flipInX">
                                <img src="<?=base_url();?>img/user/user-3.jpg" alt="Mia Donovan" />
                            </div>
                            <div class="info">
        ...
        <div id="quote" class="content bg-black-darker has-bg" data-scrollview="true">
            <!-- begin content-bg -->
            <div class="content-bg">
                <img src="<?=base_url();?>img/bg/bg-quote.jpg" alt="Quote" />
            </div>
            <!-- end content-bg -->
            <!-- begin container -->
        ...
        <div id="action-box" class="content has-bg" data-scrollview="true">
            <!-- begin content-bg -->
            <div class="content-bg">
                <img src="<?=base_url();?>img/bg/bg-action.jpg" alt="Action" />
            </div>
            <!-- end content-bg -->
            <!-- begin container -->
            ...
            <div class="container" data-animation="true" data-animation-type="fadeInDown">
                ...
                <div class="row row-space-10">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="work">
                            <div class="image">
                                <a href="#"><img src="<?=base_url();?>img/work/work-img-1.jpg" alt="Work 1" /></a>
                            </div>
                            <div class="desc">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="work">
                            <div class="image">
                                <a href="#"><img src="<?=base_url();?>img/work/work-img-2.jpg" alt="Work 2" /></a>
                            </div>
                            <div class="desc">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="work">
                            <div class="image">
                                <a href="#"><img src="<?=base_url();?>img/work/work-img-3.jpg" alt="Work 3" /></a>
                            </div>
                            <div class="desc">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="work">
                            <div class="image">
                                <a href="#"><img src="<?=base_url();?>img/work/work-img-4.jpg" alt="Work 4" /></a>
                            </div>
                            <div class="desc">
                ...
                <div class="row row-space-10">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="work">
                            <div class="image">
                                <a href="#"><img src="<?=base_url();?>img/work/work-img-5.jpg" alt="Work 5" /></a>
                            </div>
                            <div class="desc">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="work">
                            <div class="image">
                                <a href="#"><img src="<?=base_url();?>img/work/work-img-6.jpg" alt="Work 6" /></a>
                            </div>
                            <div class="desc">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="work">
                            <div class="image">
                                <a href="#"><img src="<?=base_url();?>img/work/work-img-7.jpg" alt="Work 7" /></a>
                            </div>
                            <div class="desc">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="work">
                            <div class="image">
                                <a href="#"><img src="<?=base_url();?>img/work/work-img-8.jpg" alt="Work 8" /></a>
                            </div>
                            <div class="desc">
        ...
        <div id="client" class="content has-bg bg-green" data-scrollview="true">
            <!-- begin content-bg -->
            <div class="content-bg">
                <img src="<?=base_url();?>img/bg/bg-client.jpg" alt="Client" />
            </div>
            <!-- end content-bg -->
            <!-- begin container -->
